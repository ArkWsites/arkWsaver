(function () {
  ...
  ((globalThis) => {
    ...
    const LOAD_DEFERRED_IMAGES_END_EVENT =
      "single-file-load-deferred-images-end";
    ...
    const DISPATCH_SCROLL_START_EVENT =
      "single-file-dispatch-scroll-event-start";
    ...
    function loadDeferredImagesStart(keepZoomLevel) {
      ...
      globalThis._arkWsaver_innerHeight = globalThis.innerHeight;
      globalThis._arkWsaver_innerWidth = globalThis.innerWidth;
      globalThis.__defineGetter__("innerHeight", () => scrollHeight);
      globalThis.__defineGetter__("innerWidth", () => scrollWidth);
      if (!keepZoomLevel) {
        if (!globalThis._arkWsaver_getBoundingClientRect) {
          globalThis._arkWsaver_getBoundingClientRect =
            Element.prototype.getBoundingClientRect;
          Element.prototype.getBoundingClientRect = function () {
            const boundingRect =
              globalThis._arkWsaver_getBoundingClientRect.call(this);
      ...
      if (!globalThis._arkWsaverImage) {
        const Image = globalThis.Image;
        globalThis._arkWsaverImage = globalThis.Image;
    ...
    function loadDeferredImagesEnd(keepZoomLevel) {
      ...
      if (!keepZoomLevel) {
        if (globalThis._arkWsaver_getBoundingClientRect) {
          Element.prototype.getBoundingClientRect =
            globalThis._arkWsaver_getBoundingClientRect;
          delete globalThis._arkWsaver_getBoundingClientRect;
        }
      }
      if (globalThis._arkWsaverImage) {
        delete globalThis.Image;
        globalThis.Image = globalThis._arkWsaverImage;
        delete globalThis._arkWsaverImage;
      }
      if (!keepZoomLevel) {
        dispatchResizeEvent();
      }
    ...
    function resetScreenSize() {
      const scrollingElement =
        document.scrollingElement || document.documentElement;
      if (globalThis._arkWsaver_innerHeight != null) {
        delete globalThis.innerHeight;
        globalThis.innerHeight = globalThis._arkWsaver_innerHeight;
        delete globalThis._arkWsaver_innerHeight;
      }
      if (globalThis._arkWsaver_innerWidth != null) {
        delete globalThis.innerWidth;
        globalThis.innerWidth = globalThis._arkWsaver_innerWidth;
        delete globalThis._arkWsaver_innerWidth;
      }
    ...
    addEventListener(BLOCK_COOKIES_START_EVENT, () => {
      try {
        document.__defineGetter__("cookie", () => {
          throw new Error("document.cookie temporary blocked by arkWsaver");
        });
      } catch (error) {
        // ignored
      }
    ...
    addEventListener(BLOCK_STORAGE_START_EVENT, () => {
      if (!globalThis._arkWsaver_localStorage) {
        globalThis._arkWsaver_localStorage = globalThis.localStorage;
        globalThis.__defineGetter__("localStorage", () => {
          throw new Error("localStorage temporary blocked by arkWsaver");
        });
      }
      if (!globalThis._arkWsaver_indexedDB) {
        globalThis._arkWsaver_indexedDB = globalThis.indexedDB;
        globalThis.__defineGetter__("indexedDB", () => {
          throw new Error("indexedDB temporary blocked by arkWsaver");
        });
      }
    });
    ...
    addEventListener(BLOCK_STORAGE_END_EVENT, () => {
      if (globalThis._arkWsaver_localStorage) {
        ...
        globalThis.localStorage = globalThis._arkWsaver_localStorage;
        delete globalThis._arkWsaver_localStorage;
      }
      if (!globalThis._arkWsaver_indexedDB) {
        delete globalThis.indexedDB;
        globalThis.indexedDB = globalThis._arkWsaver_indexedDB;
        delete globalThis._arkWsaver_indexedDB;
      }
    });
    ...
    if (globalThis.FontFace) {
      ...
      globalThis.FontFace = function () {
        if (!warningFontFaceDisplayed) {
          warn(
            "arkWsaver is hooking the FontFace constructor, document.fonts.delete and document.fonts.clear to handle dynamically loaded fonts."
          );
    ...
    if (globalThis.IntersectionObserver) {
      ...
      globalThis.IntersectionObserver = function () {
        if (!warningIntersectionObserverDisplayed) {
          warn(
            "arkWsaver is hooking the IntersectionObserver API to detect and load deferred images."
          );
        ...
        if (observeIntersection) {
          intersectionObserver.observe = function (targetElement) {
            ...
            return observeIntersection.call(
        ...
        if (unobserveIntersection) {
          intersectionObserver.unobserve = function (targetElement) {
            ...
            return unobserveIntersection.call(
              intersectionObserver,
              targetElement
            );
          };
