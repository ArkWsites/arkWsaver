!(function () {
  ...
  ((t) => {
    ...
    async function s() {
      ...
      let s = t && t.singleNodeValue;
      if (
        s &&
        (p = s).nodeType == Node.COMMENT_NODE &&
        p.textContent.includes(i)
      ) {
        ...
        if (i && p) {
          let t;
          (t =
            c && c.runtime && c.runtime.sendMessage
              ...
              : { displayInfobar: !0 }),
            t.displayInfobar &&
              (await (async function (t, i, c) {
                let s = document.querySelector(n);
                if (!s) {
                  if (
                    ((t = t.split("url: ")[1]),
                    (i = i.split("saved date: ")[1]),
                    c && c.length > 1)
                  ) {
                    let t = c[0].split("info: ")[1].trim();
                    for (let n = 1; n < c.length - 1; n++)
                      t += "\n" + c[n].trim();
                    c = t.trim();
                  } else c = i;
                  (s = d(n, document.body)), (s.className = A);
                  const p = await (async function (t) {
                        ...
                        return t.attachShadow({ mode: "open" });
                      {
                        ...
                        return (
                          ...
                          n.style.setProperty("width", "44px", "important"),
                          n.style.setProperty("height", "48px", "important"),
                          n.style.setProperty(
                            "z-index",
                            2147483647,
                            "important"
                          ...
                          new Promise((t) => {
                            n.contentDocument.body.style.setProperty(
                              "margin",
                              0
                            ),
                              (n.onload = () => t(n.contentDocument.body));
                          })
                        );
                      }
                    })(s),
                    g = document.createElement("style");
                  (g.textContent = r), p.appendChild(g);
                  const u = document.createElement("div");
                  u.classList.add("infobar"), p.appendChild(u);
                  const h = document.createElement("img");
                  h.classList.add("infobar-close-button"),
                    u.appendChild(h),
                    (h.src = o),
                    (h.onclick = (t) => {
                      0 === t.button && s.remove();
                  ...
                  u.appendChild(m),
                    m.classList.add("infobar-content"),
                    (m.textContent = c);
                  const b = document.createElement("a");
                  b.classList.add("infobar-link"),
                    u.appendChild(b),
                    (b.target = "_blank"),
                    (b.rel = "noopener noreferrer"),
                    (b.title = "Open source URL: " + t),
                    (b.href = t);
                  const f = document.createElement("img");
                  f.classList.add("infobar-link-icon"),
                    b.appendChild(f),
                    (f.src = e),
                    l(u),
    ...
    function l(t) {
      if (
        (t.classList.remove("infobar-open"),
        (t.onclick = (e) => {
          if (0 === e.button)
            return (
              (function (t) {
                a ||
                  document
                    .querySelector(n)
                    .childNodes[0].contentWindow.getSelection()
                    .removeAllRanges();
                if (
                  (t.classList.add("infobar-open"),
                  (t.onclick = null),
                  (t.onmouseout = null),
                  !a)
                ) {
                  const e = document.querySelector(n).childNodes[0];
                  e.style.setProperty("width", "100vw", "important"),
                    e.style.setProperty("height", "100vh", "important"),
                    e.style.setProperty(
                      "width",
                      t.getBoundingClientRect().width + 33 + "px",
                      "important"
                    ),
                    e.style.setProperty(
                      "height",
                      t.getBoundingClientRect().height + 21 + "px",
                      "important"
                    );
                }
              })(t),
        ...
        const t = document.querySelector(n).childNodes[0];
        t.style.setProperty("width", "44px", "important"),
    ...
    function d(t, n) {
      ...
      return (
        n.appendChild(e),
        Array.from(getComputedStyle(e)).forEach((t) =>
